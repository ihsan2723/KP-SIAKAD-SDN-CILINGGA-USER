            ...
            <div class="container">
                <nav class="navbar">
                    <div id="indikator">
                        ...
                        <h5>Halaman presensi Siswa Kelas 5</h5>
                    </div>
                    <ul>
                        <li>Admin |</li>
                        ...
                        <div class="tabel">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>A</td>
                                    <td>
                                        <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="tampilpresensikls5A.php"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    ...
                                    <td>B</td>
                                    <td>
                                        <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="tampilpresensikls5B.php"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3.</td>
