    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="container">
                <nav class="navbar">
                    <div id="indikator">
                        <a href="kelolanilai.php" class="bi bi-arrow-left"></a>
                        <h5>Halaman Biodata Guru</h5>
                    </div>
                    <ul>
                        <li>Admin |</li>
                    ...
                    <div class="container">
                        ...
                        <div class="profile-card">
                            <div class="profile-image">
                                <img src="../gambar/logosd.png" alt="Profile Picture">
                            </div>
                            <div class="profile-info">
                                <h1>John Doe</h1>
                                <p><strong>No Induk:</strong> 0011</p>
                                <p><strong>Nama Guru:</strong> Widia Nurindri</p>
                                <p><strong>Kedudukan:</strong> PNS</p>
                                <p><strong>Alamat:</strong> Majalengka</p>
                            </div>
                        </div>
