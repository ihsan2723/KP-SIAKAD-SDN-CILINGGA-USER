            ...
            <div class="container">
                <nav class="navbar">
                    <div id="indikator">
                        ...
                        <h5>Halaman Kelola Nilai Kelas 3</h5>
                    </div>
                    <ul>
                        <li>Admin |</li>
                        ...
                        <div class="tabel">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>A</td>
                                    <td>
                                        <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="mapelkls3A.php"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    ...
                                    <td>B</td>
                                    <td>
                                        <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="mapelkls3B.php"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3.</td>
