    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="container">
                <nav class="navbar">
                    <div id="indikator">
                        <a href="indo.php" class="bi bi-arrow-left"></a>
                        <h5>Input Nilai Bahasa Indonesia</h5>
                    </div>
                    <ul>
                        <li>Admin |</li>
                        ...
                        <div class="tabel">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>9/30</td>
                                    <td>
                                        <input class="input" type="text" style="background-color: #FEFAE0; border:none; width:30px;">
                                    </td>
                                    <td>
                                        <input class="input" type="text" style="background-color: #FEFAE0; border:none; width:30px;">
                                    </td>
                            ...
                            <div class="simpan">
                                <button class="bg-success text-light" style="padding: 7px 30px; border:none; float:right;">Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
