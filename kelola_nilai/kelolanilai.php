    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="container">
                ...
                <hr />
                <div class="box">
                    <a href="kelolanilai1.php">
                        <div class="items">
                            <h3>Kelas 1</h3>
                        </div>
                    </a>
                    <a href="kelolanilai2.php">
                        <div class="items">
                            <h3>Kelas 2</h3>
                        </div>
                    </a>
                    <a href="kelolanilai3.php">
                        <div class="items">
                            <h3>Kelas 3</h3>
                        </div>
                    </a>
                    <a href="kelolanilai4.php">
                        <div class="items">
                            <h3>Kelas 4</h3>
                        </div>
                    </a>
                    <a href="kelolanilai5.php">
                        <div class="items">
                            <h3>Kelas 5</h3>
                        </div>
                    </a>
                    <a href="kelolanilai6.php">
                        <div class="items">
                            <h3>Kelas 6</h3>
                        </div>
                    </a>
